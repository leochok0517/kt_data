"""LivePOP full pipeline 2018-01 ~ 2023-12 (72 months).

Idempotent: skips months whose output parquet already exists.
Per-month summary appended to logs/livepop_full_summary.csv.
"""
...
SUMMARY_CSV = LOG_DIR / "livepop_full_summary.csv"
...
def process_month(yyyymm: str, mapping: pl.DataFrame, sudo_codes: list[str]) -> dict:
    ...
    out = OUT_DIR / f"livepop_sudogwon_{yyyymm}.parquet"
    row = {"yyyymm": yyyymm}
